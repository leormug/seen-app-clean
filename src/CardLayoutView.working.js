  ...
  diagnoses: [
    {
      ...
      date: "June 2008",
      status: "confirmed", // matches Status: Confirmed
    },
  ],
  ...
  testsImaging: [
    {
      test: "Echocardiogram",
      finding:
        "Normal structure and function. Functional impact: Helped rule out cardiac cause of dizziness.",
      date: "January 2014",
    },
  ],
...
export default function CardLayoutView({
  ...
  const [localPatient, setLocalPatient] = useState(patientPermanent || {});
 ...
 const P_live = {
  ...(typeof setPatientPermanent === "function"
    ? patientPermanent || {}
    : localPatient || {}),
};
...
const P_default = {
  ...PATIENT_DEFAULTS_FALLBACK,
  ...(patientDefaults || {}),
};
const V_default = {
  ...VISIT_DEFAULTS_FALLBACK,
  ...(visitDefaults || {}),
};
  ...
  if (typeof setPatientPermanent === "function") {
    ...
    setLocalPatient(next);
    try {
      localStorage.setItem("patientPermanent", JSON.stringify(next));
    } catch {}
  }
}
...
>
  <section style={cardOuterStyle}>
    ...
    {(
  Array.isArray(P_live.diagnoses) && P_live.diagnoses.length
    ? P_live.diagnoses
    : [
        {
          name: "",
  ...
  P_live.hospitalizations.length
    ...
    : [
      ...
      <div ref={sectionRefs.current.meds} data-section-id="meds">
        <section style={cardOuterStyle}>
          ...
          {(
  Array.isArray(P_live.allergies) && P_live.allergies.length
    ? P_live.allergies
    : [
        {
          item: "",
      ...
      <div ref={sectionRefs.current.procedures} data-section-id="procedures">
        <section style={cardOuterStyle}>
          ...
          {(
  Array.isArray(P_live.procedures) && P_live.procedures.length
    ? P_live.procedures
    : [
        {
          name: "",
      ...
      <div ref={sectionRefs.current.treatments} data-section-id="treatments">
        <section style={cardOuterStyle}>
          ...
          {(
  Array.isArray(P_live.treatments) && P_live.treatments.length
    ? P_live.treatments
    : [
        {
          name: "",
      ...
      <div ref={sectionRefs.current.tests} data-section-id="tests">
        <section style={cardOuterStyle}>
          ...
          {(
  Array.isArray(P_live.testsImaging) && P_live.testsImaging.length
    ? P_live.testsImaging
    : [
        {
          test: "",
      ...
      <div ref={sectionRefs.current.docs} data-section-id="docs">
        <section style={cardOuterStyle}>
          ...
          {(
  Array.isArray(P_live.doctors) && P_live.doctors.length
    ? P_live.doctors
    : [
        {
          name: "",
